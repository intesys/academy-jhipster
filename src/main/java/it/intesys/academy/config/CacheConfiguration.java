...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.intesys.academy.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.intesys.academy.repository.UserRepository.USERS_BY_EMAIL_CACHE);
