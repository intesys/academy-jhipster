...
import it.intesys.academy.config.audit.AuditEventConverter;
import it.intesys.academy.domain.PersistentAuditEvent;
...
import static it.intesys.academy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
